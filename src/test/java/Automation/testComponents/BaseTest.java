...
public class BaseTest {
	...
	public WebDriver initializeDriver() throws IOException {
		...
		//to check the browser type dynamically  from maven command in terminal
		...
		{	
		   ...
		   driver.manage().window().setSize(new Dimension(1440,900));//full screen when we run in headless mode 
